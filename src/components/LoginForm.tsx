...
// console.log('Login response data:', data);
      if (response.ok) {
        ...
        // Store user data in sessionStorage instead of localStorage (expires when browser closes)
  ...
  return (
    <div className="w-full max-w-3xl mx-auto bg-white rounded-3xl shadow-2xl p-16 border border-gray-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <p className="text-center text-gray-600 text-lg">
          ...
          <a href="/register" className="text-pink-500 hover:text-pink-600 font-bold">
            Sign up
          </a>
        </p>
      </form>
